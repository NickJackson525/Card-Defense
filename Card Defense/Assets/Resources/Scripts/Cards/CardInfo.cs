...
public class CardInfo
{
    ...
    public string cardType;                 //the type of card this is
    ...
    public CardInfo(Cards name, string type, int cost, int damage, int range, string text, Sprite watermark, Sprite tower, Sprite card, bool spell, bool locked)
    {
        thisCardName = name;
        cardType = type;
        towerCost = cost;
