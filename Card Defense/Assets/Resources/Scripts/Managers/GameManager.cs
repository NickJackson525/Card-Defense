...
public enum CardElement { Cost, Damage, Range, Level, CardText, WatermarkSprite, GrassTowerSprite, SnowTowerSprite, DesertTowerSprite, CardSprite, CardOutlineSprite, CardArtSprite, IsSpell, IsLocked, CardType, HasBeenLookedAt }
...
class GameManager
{
    ...
    public Dictionary<Cards, Dictionary<CardElement, string>> CardLibrary = new Dictionary<Cards, Dictionary<CardElement, string>>
    {
        ...
        {//TODO: type
            ...
            Cards.BasicResource, new Dictionary<CardElement, string>
            {
                ...
                { CardElement.GrassTowerSprite, "Sprites/Towers/GreyTower1" },
                { CardElement.SnowTowerSprite, "Sprites/Towers/BlueTower1" },
                { CardElement.DesertTowerSprite, "Sprites/Towers/TanTower1" },
        ...
        {//TODO: type
            ...
            Cards.Basic, new Dictionary<CardElement, string>
            {
                ...
                { CardElement.WatermarkSprite, "Sprites/Cards/Basic/Basic Symbol" },
                { CardElement.GrassTowerSprite, "Sprites/Towers/GreyTower2" },
                { CardElement.SnowTowerSprite, "Sprites/Towers/BlueTower2" },
                { CardElement.DesertTowerSprite, "Sprites/Towers/TanTower2" },
                { CardElement.CardSprite, "Sprites/Cards/Basic/Basic Card Back" },
                { CardElement.CardOutlineSprite, "Sprites/Cards/Basic/Basic Card Back Outline" },
        ...
        {//TODO: type
            ...
            Cards.MediumBasic, new Dictionary<CardElement, string>
            {
                ...
                { CardElement.WatermarkSprite, "Sprites/Cards/Basic/Basic Symbol" },
                { CardElement.GrassTowerSprite, "Sprites/Towers/GreyTower3" },
                { CardElement.SnowTowerSprite, "Sprites/Towers/BlueTower3" },
                { CardElement.DesertTowerSprite, "Sprites/Towers/TanTower3" },
                { CardElement.CardSprite, "Sprites/Cards/Basic/Basic Card Back" },
                { CardElement.CardOutlineSprite, "Sprites/Cards/Basic/Basic Card Back Outline" },
        ...
        {//TODO: type
            ...
            Cards.HeavyBasic, new Dictionary<CardElement, string>
            {
                ...
                { CardElement.WatermarkSprite, "Sprites/Cards/Basic/Basic Symbol" },
                { CardElement.GrassTowerSprite, "Sprites/Towers/GreyTower4" },
                { CardElement.SnowTowerSprite, "Sprites/Towers/BlueTower4" },
                { CardElement.DesertTowerSprite, "Sprites/Towers/TanTower4" },
                { CardElement.CardSprite, "Sprites/Cards/Basic/Basic Card Back" },
                { CardElement.CardOutlineSprite, "Sprites/Cards/Basic/Basic Card Back Outline" },
    ...
    public CardInfo CreateCard(Cards cardToMake)
    {
        ...
        CardInfo createdCard = new CardInfo(
            ...
            Resources.Load<Sprite>(Instance.CardLibrary[cardToMake][CardElement.GrassTowerSprite]),
